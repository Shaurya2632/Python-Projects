...
class Calculator:
    def __init__(self, master):
        ...
        self.master.iconbitmap(r"D:\coding\python\Calc.ico")
        ...
        self.display_container = tk.Frame(self.master, bg="#000000", bd=0)
        self.display_container.pack(fill="x", padx=20, pady=(20, 10))
        
        # Display background - regular rectangle instead of rounded corners
        self.display_bg = tk.Canvas(self.display_container, bg="#0a0a0a", 
        ...
        self.history = tk.Label(self.display_container, textvariable=self.history_var, 
                               font=("Arial", 15), bg="#0a0a0a", fg="#888888", 
                               anchor="e", padx=15)
        self.history.place(x=20, y=15, width=380, height=40)
        
        # Main display
        self.result = tk.Label(self.display_container, textvariable=self.result_var, 
                              font=("Arial", 28, "bold"), bg="#0a0a0a", fg="#ffffff", 
                              anchor="e", padx=15)
        self.result.place(x=20, y=60, width=380, height=45)
        
        # Buttons container
        self.buttons_container = tk.Frame(self.master, bg="#000000", bd=0)
